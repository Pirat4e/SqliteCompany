package com.empire.sqlitecompany.activities;
...
import com.empire.sqlitecompany.R;
import com.empire.sqlitecompany.adapter.SpinnerCompaniesAdapter;
import com.empire.sqlitecompany.dao.CompanyDAO;
import com.empire.sqlitecompany.dao.EmployeeDAO;
import com.empire.sqlitecompany.model.Company;
import com.empire.sqlitecompany.model.Employee;
...
/**
 * Created by Ivanco on 18.05.2015.
 */
        ...
        switch (v.getId()) {
            case R.id.btn_add:
                ...
                if (!TextUtils.isEmpty(firstName) && !TextUtils.isEmpty(lastName)
                    ...
                    Employee createdEmployee = mEmployeeDao.createEmploye(firstName.toString()+currentDateTimeString, lastName.toString(), address.toString(), email.toString(), phoneNumber.toString(), salary, mSelectedCompany.getId());
